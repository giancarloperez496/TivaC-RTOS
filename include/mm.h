...
#define REGION_0_ADDR_TOP 0x20002000
#define REGION_1_ADDR_TOP 0x20003000
#define REGION_2_ADDR_TOP 0x20004000
#define REGION_3_ADDR_TOP 0x20006000
...
uint64_t inUse; //64 bit field, use 39:0 for the 8*5 subregions
